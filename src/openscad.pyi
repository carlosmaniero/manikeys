"""PyOpenSCAD" Stub File for use in editors like Visual Studio Code"""

from typing import Union, Optional, overload, List, Self
...
class PyOpenSCAD:
    ...
    def rotate(
        self,
        a: Union[float, Vector3],
        v: Optional[Vector3] = None,
        ref: Optional[Vector3] = None,
    ) -> "PyOpenSCAD":
        """Rotate this object.
    ...
    def pull(self, src: Self, dst: Self) -> Self:
    ...
    def oversample(
        self, n: Optional[int] = None, round: Optional[bool] = None
    ) -> Self:
...
def square(
    dim: Optional[Union[float, list[float]]] = None,
    center: Optional[bool] = None,
) -> PyOpenSCAD:
...
def frep(
    exp: PyLibFive, min: List[float], max: List[float], res: int
) -> PyOpenSCAD:
...
def edge(
    size: Optional[Union[float, Vector2]] = None, center: Optional[bool] = None
) -> PyOpenSCAD:
