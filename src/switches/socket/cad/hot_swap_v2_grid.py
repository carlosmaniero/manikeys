...
@inject
@dataclass
class HotSwapV2GridCAD(ManifoldObject):
    layout: Layout
    ...
    def assemble(self) -> manifold3d.Manifold:
        ...
        hot_swap = self.deps.stls[
            "build/switches/socket/cad/hot_swap_v2.stl"
        ].rotate([180, 0, 180])
...
if __name__ == "__main__":
    hot_swap_v2_grid = injector.get(HotSwapV2GridCAD)
    hot_swap_v2_grid.program(sys.argv)
