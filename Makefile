...
build/render.3mf: src/render.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/main.3mf
build/assembly/cad/full_keyboard.stl build/full_keyboard.3mf: src/assembly/cad/full_keyboard.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py src/switches/socket/mount/models.py build/structure/body/shape.stl build/structure/body/cad/body_cavity_sections.stl build/structure/body/screws/cad/placement.stl build/structure/body/screws/cad/hole.stl build/switches/cad/switch_hole_decorator_grid.stl build/switches/cad/switch_hole_grid.stl build/switches/cad/switch_decorator_thumb_grid.stl build/switches/cad/switch_thumb_hole.stl build/connectors/pogo/cad/cable_path.stl build/connectors/usbc/cad/masks/usbc.stl build/connectors/usbc/cad/adapter_trimmed.stl build/connectors/magnet/cad/snap.stl build/components/light_indicator/cad/masks/body.stl build/components/light_indicator/cad/panel_frame.stl build/components/oled_096/cad/masks/body.stl build/components/oled_096/cad/placement.stl build/assembly/base_plate/cad/masks/base_plate.stl build/connectors/rj45_tabs/cad/masks/body.stl build/connectors/rj45_tabs/cad/placement.stl
...
build/structure/body/screws/cad/placement.stl: src/structure/body/screws/cad/placement.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/screws/models.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/structure/body/shape.stl
build/switches/socket/mount/cad/screw_clearance.stl: src/switches/socket/mount/cad/screw_clearance.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py
build/switches/socket/mount/cad/screw_clearance_cavity.stl: src/switches/socket/mount/cad/screw_clearance_cavity.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py
build/structure/body/screws/cad/hole.stl: src/structure/body/screws/cad/hole.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py
build/assembly/base_plate/cad/base_plate.stl: src/assembly/base_plate/cad/base_plate.py src/assembly/base_plate/model.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py
...
build/switches/socket/mount/cad/pcbs_placement.stl: src/switches/socket/mount/cad/pcbs_placement.py src/switches/socket/mount/model.py src/switches/socket/mount/models.py src/switches/socket/mount/parameters.py src/assembly/base_plate/parameters.py src/components/arduino_nano_case/model.py src/components/arduino_nano_case/parameters.py src/components/arduino_pro_micro_case/model.py src/components/arduino_pro_micro_case/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py build/components/arduino_nano_case/cad/case.stl build/components/arduino_pro_micro_case/cad/housing.stl
build/switches/socket/cad/hot_swap_placement_mask_grid.stl: src/switches/socket/cad/hot_swap_placement_mask_grid.py src/globals/wall/parameters.py src/models/parameters.py src/models/switch_thumb.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py src/switches/socket/mount/models.py build/switches/socket/cad/hot_swap_placement_mask.stl
build/switches/socket/mount/cad/shell.stl: src/switches/socket/mount/cad/shell.py src/switches/socket/mount/models.py src/switches/socket/mount/parameters.py src/assembly/base_plate/parameters.py src/components/female_pin_header/model.py src/components/female_pin_header/parameters.py src/connectors/pogo/models.py src/connectors/pogo/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py build/switches/socket/mount/cad/body.stl build/switches/socket/mount/cad/cavity_sections.stl build/connectors/rj45_tabs/cad/masks/shell.stl build/connectors/usbc/cad/masks/placement.stl build/switches/socket/mount/cad/screw_clearance.stl build/switches/socket/mount/cad/screw_clearance_cavity.stl build/switches/cad/switch_hole_decorator_shell_grid.stl build/switches/cad/switch_hole_decorator_cable_matrix_pocket_grid.stl build/switches/socket/cad/hot_swap_placement_mask_grid.stl build/switches/cad/switch_hole_grid.stl build/switches/cad/switch_thumb_hole.stl build/connectors/pogo/cad/cable_path.stl build/components/light_indicator/cad/masks/body_shell.stl build/components/oled_096/cad/masks/shell.stl build/components/oled_096/cad/masks/shell_cavity.stl build/components/oled_096/cad/masks/cable.stl build/assembly/base_plate/cad/masks/base_plate.stl build/switches/socket/mount/cad/col_cable_path.stl build/switches/socket/mount/cad/row_cable_path.stl build/switches/socket/mount/cad/shell_side_mask.stl $(PIN_HEADERS_STLS)
...
build/switches/socket/mount/cad/col_cable_path.stl: src/switches/socket/mount/cad/col_cable_path.py src/switches/socket/mount/models.py src/components/female_pin_header/model.py src/components/female_pin_header/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/components/cable_hook/cad/cable_hook.stl $(PIN_HEADERS_STLS)
build/switches/socket/mount/cad/row_cable_path.stl: src/switches/socket/mount/cad/row_cable_path.py src/switches/socket/mount/models.py src/components/female_pin_header/model.py src/components/female_pin_header/parameters.py src/connectors/pogo/models.py src/connectors/pogo/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py $(PIN_HEADERS_STLS)
...
build/switches/cad/switch_hole_decorator_shell.stl: src/switches/cad/switch_hole_decorator_shell.py src/globals/wall/parameters.py src/models/parameters.py src/switches/model.py build/switches/cad/switch_hole.stl
build/switches/cad/switch_hole_decorator_cable_matrix.stl: src/switches/cad/switch_hole_decorator_cable_matrix.py src/globals/wall/parameters.py src/models/parameters.py src/switches/model.py
build/switches/cad/switch_hole_decorator_cable_matrix_grid.stl: src/switches/cad/switch_hole_decorator_cable_matrix_grid.py src/globals/wall/parameters.py src/models/parameters.py src/models/switch_thumb.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py src/switches/socket/mount/models.py build/switches/cad/switch_hole_decorator_cable_matrix.stl
build/switches/cad/switch_hole_decorator_cable_matrix_pocket_grid.stl: src/switches/cad/switch_hole_decorator_cable_matrix_pocket_grid.py src/globals/wall/parameters.py src/models/parameters.py src/models/switch_thumb.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py src/switches/socket/mount/models.py
...
build/switches/socket/cad/hot_swap_v2_grid.stl: src/switches/socket/cad/hot_swap_v2_grid.py src/globals/wall/parameters.py src/models/parameters.py src/models/switch_thumb.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py src/switches/socket/mount/models.py build/switches/socket/cad/hot_swap_v2.stl
...
build/assembly/base_plate/cad/masks/base_plate.stl: src/assembly/base_plate/cad/masks/base_plate.py src/assembly/base_plate/model.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py
...
build/connectors/rj45/cad/adapter_placement.stl: src/connectors/rj45/cad/adapter_placement.py src/connectors/rj45/model.py src/connectors/rj45/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/connectors/rj45/cad/adapter.stl
build/connectors/rj45/cad/adapter.stl: src/connectors/rj45/cad/adapter.py src/connectors/rj45/model.py src/connectors/rj45/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py
build/connectors/rj45_tabs/cad/adapter.stl: src/connectors/rj45_tabs/cad/adapter.py src/connectors/rj45_tabs/model.py src/connectors/rj45_tabs/parameters.py src/globals/wall/parameters.py
build/connectors/rj45_tabs/cad/placement.stl: src/connectors/rj45_tabs/cad/placement.py src/connectors/rj45_tabs/model.py src/connectors/rj45_tabs/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/connectors/rj45_tabs/cad/adapter.stl build/structure/body/shape.stl
build/connectors/rj45_tabs/cad/masks/body.stl: src/connectors/rj45_tabs/cad/masks/body.py src/connectors/rj45_tabs/model.py src/connectors/rj45_tabs/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py
build/connectors/rj45_tabs/cad/masks/shell.stl: src/connectors/rj45_tabs/cad/masks/shell.py src/connectors/rj45_tabs/model.py src/connectors/rj45_tabs/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py
...
build/assembly/base_plate/cad/main.stl: src/assembly/base_plate/cad/main.py src/assembly/base_plate/model.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py build/assembly/base_plate/cad/base_plate.stl
build/assembly/cad/supports/main.stl: src/assembly/cad/supports/main.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/assembly/cad/main.stl build/structure/body/shape.stl build/structure/body/screws/cad/hole.stl build/assembly/base_plate/cad/main.stl
...
build/switches/socket/cad/hot_swap_v2.stl: src/switches/socket/cad/hot_swap_v2.py src/components/light_indicator/parameters.py src/globals/wall/parameters.py src/switches/socket/parameters.py
...
build/switches/socket/mount/cad/shell_side_mask.stl: src/switches/socket/mount/cad/shell_side_mask.py src/assembly/base_plate/parameters.py src/globals/screw/parameters.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/structure/body/screws/models.py src/switches/model.py src/switches/socket/mount/models.py
viewer:
