...
build/assembly/cad/supports/main.stl: src/assembly/cad/supports/main.py src/globals/wall/parameters.py src/models/parameters.py src/structure/body/models.py src/structure/body/parameters.py src/switches/model.py build/assembly/cad/main.stl build/structure/body/shape.stl build/structure/body/screws/cad/hole.stl
